...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Travel Comfort Online Ticketing</a>
    </div>
				...
				<div class="row">
					<div class="col-md-3">
						<div class="panel panel-default">
							<div class="panel-heading">
								<h3 class="panel-title">1. TRAIN TIMINGS
								</h3>
							</div>
							<div class="panel-body">
								SCHEDULE OF TRAINS
		...
		<div class="panel panel-default">
			<div class="panel-body">
			 ...
			 <div class="panel panel-success">
			 	...
			 	<div class="panel-body">
			 		<strong>
			 			<i>Travel Comfort Transport, M/V Lady of All Nations</i>
			 			<h3>
